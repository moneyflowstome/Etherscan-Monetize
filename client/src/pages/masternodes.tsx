      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 pt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <Card className="glass-panel border-white/5">
              <CardContent className="p-5">
                ...
                <div className="text-2xl font-bold font-display text-white" data-testid="text-total-coins">{coins.length}</div>
              </CardContent>
            </Card>
            <Card className="glass-panel border-white/5">
              <CardContent className="p-5">
                ...
                <div className="text-2xl font-bold font-display text-white" data-testid="text-avg-collateral">
        ...
        <div className="glass-panel rounded-2xl p-6 mt-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 text-sm text-muted-foreground">
            ...
            <div>
              <h3 className="text-white font-medium mb-2">Key Terms</h3>
