...
const ALL_CHAINS: ChainInfo[] = [
  ...
  { id: "brett", name: "Brett", symbol: "BRETT", icon: "🧢", color: "from-blue-400/20 to-blue-500/10 border-blue-400/30", description: "Base chain's leading memecoin", coingeckoId: "based-brett", hasAddressLookup: false },
