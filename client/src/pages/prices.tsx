    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 pt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mt-6">
          <a href="https://www.tradingview.com/pricing/?share_your_love=moneyflowstome78&mobileapp=true" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 p-3 rounded-xl bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/20 hover:border-cyan-400/40 transition-all group" data-testid="banner-tradingview-prices">
            <Activity className="w-5 h-5 text-cyan-400 shrink-0" />
            <div className="flex-1 min-w-0">
              <p className="text-xs font-semibold text-foreground">TradingView</p>
              <p className="text-[10px] text-muted-foreground truncate">Pro charts & indicators</p>
            </div>
            <ExternalLink className="w-3 h-3 text-muted-foreground group-hover:text-cyan-400 shrink-0" />
          </a>
          <a href="https://pineify.app/?via=Tokenaltcoin" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 p-3 rounded-xl bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20 hover:border-green-400/40 transition-all group" data-testid="banner-pineify-prices">
            <TrendingUp className="w-5 h-5 text-green-400 shrink-0" />
            <div className="flex-1 min-w-0">
              <p className="text-xs font-semibold text-foreground">Pineify</p>
              <p className="text-[10px] text-muted-foreground truncate">No-code strategies</p>
            </div>
            <ExternalLink className="w-3 h-3 text-muted-foreground group-hover:text-green-400 shrink-0" />
          </a>
          <a href="https://click.goodcrypto.app/b9EC/ie88jiew?ref=rET1nQ" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 p-3 rounded-xl bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 hover:border-purple-400/40 transition-all group" data-testid="banner-goodcrypto-prices">
            <BarChart3 className="w-5 h-5 text-purple-400 shrink-0" />
            <div className="flex-1 min-w-0">
              <p className="text-xs font-semibold text-foreground">Good Crypto</p>
              <p className="text-[10px] text-muted-foreground truncate">All-in-one trading</p>
            </div>
            <ExternalLink className="w-3 h-3 text-muted-foreground group-hover:text-purple-400 shrink-0" />
          </a>
          <a href="https://coinbase.com/join/NC7ZTX4?src=ios-link" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 p-3 rounded-xl bg-gradient-to-r from-blue-500/10 to-indigo-500/10 border border-blue-500/20 hover:border-blue-400/40 transition-all group" data-testid="banner-coinbase-prices">
            <DollarSign className="w-5 h-5 text-blue-400 shrink-0" />
            <div className="flex-1 min-w-0">
              <p className="text-xs font-semibold text-foreground">Coinbase</p>
              <p className="text-[10px] text-muted-foreground truncate">Buy & sell crypto</p>
            </div>
