    ...
    <footer className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 mt-16 pt-8 border-t border-white/5">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 pb-8">
        ...
        <div className="flex items-center gap-4 text-xs text-muted-foreground">
          <Link href="/" className="hover:text-white transition-colors" data-testid="footer-link-tracker">Tracker</Link>
          <Link href="/prices" className="hover:text-white transition-colors" data-testid="footer-link-prices">Prices</Link>
          <Link href="/news" className="hover:text-white transition-colors" data-testid="footer-link-news">News</Link>
          <Link href="/masternodes" className="hover:text-white transition-colors" data-testid="footer-link-masternodes">Masternodes</Link>
        </div>
      </div>
